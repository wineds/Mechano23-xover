Manufacturing files for Mechano23 xover PCB.  The RAR file needs to be uploaded to the PCB vendor (eg: JLCPCB or PCBWAY etc).
...
https://github.com/wineds/Mechano23-xover/blob/main/schemat.png
